...
- [ ] Choose the GitHub namespace and npm package name for public release.
- [ ] Commit and publish the verified `v0.1.0` baseline.
- [ ] Add ranked semantic retrieval over Ollama-generated embeddings.
- [ ] Add provider execution adapters for automatic Team workflow runs.
