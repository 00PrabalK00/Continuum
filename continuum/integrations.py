...
Before you finish, record what happened with the `write_handoff` tool (or
`continuum save "<what you did> | <next step>"`) so the next agent — or the
next session — continues instead of restarting.
